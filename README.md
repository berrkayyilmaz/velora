...
- Admin product import, product search/filter UI, global navigation, and admin
  logout UI are not implemented. Catalog delete endpoints documented in the API
  specification are also absent.
